...
##  Descripción
"Quizá" es una aplicación de escritorio desarrollada en **Java Swing** para el proyecto intermodular de DAM. Permite a los usuarios poner a prueba sus conocimientos en diferentes áreas (Historia, Ciencia, Literatura) mediante un sistema de cuestionarios con temporizador y ranking local.
